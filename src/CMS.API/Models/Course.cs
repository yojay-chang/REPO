...
/// <summary>
/// Course 課程 — response model. The <c>*Pkid</c> FK values carry the JOINed parent labels
/// (<see cref="PartnerName"/> etc.) as read-only display columns. The N-N pkid lists are
