/** Course 課程 — response model (mirrors CMS.API.Models.Course).
 *  FK values carry their JOINed display labels; N-N pkid lists are filled on GET by id.
 *  Date fields cross the wire as ISO `yyyy-MM-dd` strings. */
